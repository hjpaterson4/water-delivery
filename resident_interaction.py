#this script is activated when the robot arrives at the resident's door, and is run until the person has received the water and closed the door#
#the steps in this process are: alert resident of robot's presence, start recording interaction, hand over water and encourage hydration, finish and save recording#


##########################################first step: water alert#########################################
	...
	aruco_id=201 #marker_id when implemented into full code

	roomnumber= aruco_id
	roomtext= "Hello, I am Reggie. Room {} your water delivery is here! Room {} your water delivery is here!  ".format(roomnumber)
	...
	playsound.playsound("reggie_{}.mp3".format(roomnumber))


###########################second step: start recording########################################


###########################third step: hand-off bottle# ######################################
		#!/usr/bin/env python
